    ...
    <div className="flex h-full flex-col max-h-[75vh] overflow-hidden">
      <div ref={ container } className="isolate flex flex-auto flex-col h-[80vh] overflow-y-auto scrollbar-thin scrollbar-thumb-rounded scrollbar-thumb-sky-700 scrollbar-track-sky-100">
        <div style={ { width: '165%' } } className="flex max-w-full flex-none flex-col sm:max-w-none md:max-w-full">
          <div
            ref={ containerNav }
            className="fixed w-full pr-96 z-[1000] flex-none"
          >
                  ...
                  <button key={ day.date } type="button" className="flex flex-col items-center pb-3 pt-2">
                    ...
                    }
                    {
                      day.isToday ?
                        ...
                        <span className="mt-1 flex h-8 w-8 items-center justify-center rounded-full bg-sky-600 font-semibold text-white">
            ...
            <div className="-mr-px hidden grid-cols-7 divide-x divide-gray-100 border-r border-gray-100 text-sm leading-6 text-gray-500 sm:grid bg-sky-100">
                ...
                days?.map(day => (
                  ...
                  <div key={ day.date } className="flex items-center justify-center py-3">
                    <span className='flex items-center gap-1 font-semibold'>
                      { new Date(day.date + 'T12:00:00Z').toLocaleString('en-US', { weekday: 'short' }) }
                      {
                        day.isToday ?
          ...
          <div className="flex flex-auto my-14">
