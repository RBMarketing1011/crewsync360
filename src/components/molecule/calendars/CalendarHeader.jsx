  ...
  return (
    <header className="flex items-center justify-between border-b border-gray-200 py-4 lg:flex-none sticky top-16 z-[1000] bg-white">
      <h1 className="text-base font-semibold leading-6 text-gray-900">
        <time dateTime="2022-01">{ heading && heading }</time>
      </h1>
            ...
            >
              <div className="py-1">
                <MenuItem>
                  <button
                    type='button'
                    className="w-full block px-4 py-2 text-sm text-gray-700 data-[focus]:bg-gray-100 data-[focus]:text-gray-900 text-left"
                    onClick={ () => calendarView.setState('Day') }
                  >
                    Day view
                  </button>
                </MenuItem>
                <MenuItem>
                  <button
                    type='button'
                    className="w-full block px-4 py-2 text-sm text-gray-700 data-[focus]:bg-gray-100 data-[focus]:text-gray-900 text-left"
                    onClick={ () => calendarView.setState('Week') }
                  >
                    Week view
                  </button>
                </MenuItem>
                <MenuItem>
                  <button
                    type='button'
                    className="w-full block px-4 py-2 text-sm text-gray-700 data-[focus]:bg-gray-100 data-[focus]:text-gray-900 text-left"
                    onClick={ () => calendarView.setState('Month') }
                  >
                    Month view
                  </button>
                </MenuItem>
                <MenuItem>
                  <button
                    type='button'
                    className="w-full block px-4 py-2 text-sm text-gray-700 data-[focus]:bg-gray-100 data-[focus]:text-gray-900 text-left"
                    onClick={ () => calendarView.setState('Year') }
                  >
                    Year view
                  </button>
                </MenuItem>
