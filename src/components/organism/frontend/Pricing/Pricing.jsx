  ...
  return (
    <div className="bg-white py-24 sm:py-32">
      ...
      <div className="relative pt-16 sm:pt-24">
        <div className="absolute inset-x-0 bottom-0 top-48 bg-[radial-gradient(circle_at_center_var(--gradient-position),#38BDF8,#0C4A6E,#08202b_70%)] [--gradient-position:center] lg:[--gradient-position:150%]" />
        <div className="relative mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
                ...
                >
                  <div className="grid grid-cols-1 rounded-[2rem] p-2 shadow-md shadow-black/5">
                    <div className="rounded-3xl bg-white p-10 pb-9 shadow-2xl ring-1 ring-black/5">
                      <h2 className="text-sm/5 font-semibold text-sky-600">
                      ...
                      <div className="mt-8">
                        <a
                          ...
                          className="inline-block rounded-md bg-sky-600 px-3.5 py-2 text-center text-sm/6 font-semibold text-white shadow-sm hover:bg-sky-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600"
                        >
                          Start a free trial
                        </a>
                      </div>
          ...
          <div className="flex justify-between py-8 opacity-60 max-sm:mx-auto max-sm:max-w-md max-sm:flex-wrap max-sm:justify-evenly max-sm:gap-x-4 max-sm:gap-y-4 sm:py-12">
          </div>
        </div>
      </div>
            ...
            <tr>
              ...
              { tiers.map((tier) => (
                <th key={ tier.name } scope="col" className="p-0">
                  <div className="text-sm/5 font-semibold text-sky-600">
                    { tier.name } <span className="sr-only">plan</span>
                  </div>
                </th>
              )) }
        ...
        <TabGroup className="sm:hidden">
          <TabList className="flex">
            { tiers.map((tier) => (
              <Tab
                key={ tier.name }
                className="w-1/3 border-b border-gray-100 py-4 text-base/8 font-medium text-sky-600 data-[selected]:border-sky-600 [&:not([data-focus])]:focus:outline-none"
              >
                { tier.name }
              </Tab>
            )) }
