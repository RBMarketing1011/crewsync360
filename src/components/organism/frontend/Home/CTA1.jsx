        ...
        <div className="lg:grid lg:grid-cols-12">
          ...
          <div className="relative bg-sky-600 lg:col-span-10 lg:col-start-3 lg:row-start-1 lg:grid lg:grid-cols-10 lg:items-center lg:rounded-3xl">
            <div aria-hidden="true" className="absolute inset-0 hidden overflow-hidden rounded-3xl lg:block">
              ...
              >
                <defs>
                  ...
                  >
                    <rect x={ 0 } y={ 0 } fill="currentColor" width={ 4 } height={ 4 } className="text-sky-500" />
                  </pattern>
                </defs>
            ...
            <div className="relative mx-auto max-w-md space-y-6 px-6 py-12 sm:max-w-3xl sm:py-16 lg:col-span-6 lg:col-start-4 lg:max-w-none lg:p-0">
              ...
              <a
                href="#"
                className="block w-full rounded-md border border-transparent bg-white px-5 py-3 text-center text-base font-medium text-sky-700 shadow-md hover:bg-gray-50 sm:inline-block sm:w-auto"
              >
