            ...
            >
              { frequencies.map((option) => (
                <Radio
                  key={ option.value }
                  value={ option }
                  className="cursor-pointer rounded-full px-2.5 py-1 text-gray-500 data-[checked]:bg-sky-600 data-[checked]:text-white"
                >
                  { option.label }
                </Radio>
              )) }
            ...
            >
              ...
              <a
                ...
                className={ classNames(
                  ...
                  'mt-6 block rounded-md px-3 py-2 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600',
                ) }
              >
                Buy plan
              </a>
