...
const links = [
  {
    name: 'Login',
    href: '/auth/login',
    description: 'Have an account but logged in with the wrong credentials? Try logging in again.',
...
const ErrorPage = () =>
{
  return (
    <div className="h-screen flex flex-col justify-center">
              ...
              links.map((link, linkIdx) => (
                ...
                <li key={ linkIdx } className="relative flex flex-col items-center sm:flex-row gap-y-4 gap-x-6 py-6">
                  ...
                  <div className="flex flex-col items-center sm:items-start">
                    ...
                    <p className="mt-2 text-sm text-center sm:text-left leading-6 text-gray-600">
                      { link.description }
                    </p>
                  </div>
                  <div className="flex-none self-center sm:ml-auto">
      ...
      <footer className="lg:absolute lg:w-screen lg:bottom-0 lg:left-0 border-t border-gray-100 py-6 sm:py-10">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-center gap-8 px-6 sm:flex-row lg:px-8">
          <div>
            <p className="text-xs sm:text-sm leading-7 text-gray-400">
              &copy; Juggernaut 360®, All rights reserved.
            </p>
            <a
              href='https://github.com/RbMarketing1011'
              className="lg:absolute lg:left-5 lg:bottom-9 flex items-center gap-2 text-xs sm:text-sm leading-7 text-gray-400">
              Developed by
