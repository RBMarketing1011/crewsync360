...
const authOptions = {
  ...
  providers: [
            ...
            <body style="margin: 0; padding: 0; background-color: #f9fafb; font-family: 'Arial', sans-serif;">
              <div style="max-width: 450px; margin: 20px auto; background-color: #ffffff; border-radius: 10px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1); overflow: hidden; text-align: center;">
                  <div style="background-color: rgb(79, 70, 229); color: white; padding: 40px;">
                      <h1 style="margin: 0; font-size: 28px; font-weight: bold;">Forgot Your Password?</h1>
                      <p style="margin: 10px 0; font-size: 16px;">
                      No worries! Click the button below to sign in.
                      </p>
                  </div>
                  <div style="padding: 30px;">
                      <a href="${ url }" style="display: inline-block; margin: 20px 0; padding: 15px 30px; background-color: rgb(79, 70, 229); color: white; text-decoration: none; border-radius: 5px; font-size: 18px; font-weight: bold;">
                          Sign In
                      </a>
                      <p style="font-size: 16px; line-height: 1.5; color: #374151;">
                          Once signed in, you can reset your password in your settings and continue using Juggernaut 360®.
                      </p>
                  </div>
    ...
    CredentialsProvider({
      ...
      async authorize (credentials)
      {
        ...
        {
          // Capture any unexpected error and return null
  ...
  pages: {
    ...
    newUser: '/account/new-user' // New users will be directed here on first sign in
  },
}
